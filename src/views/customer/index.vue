<template>
  <div class="customer">
    <el-card class="search-box" shadow="hover">
      <el-row :gutter="20">
        ...
        <el-col :span="4" :offset="1" :lg="6" :md="8">
          ...
          <el-button type="primary" icon="el-icon-refresh-right">上传</el-button>
        </el-col>
      </el-row>
    </el-card>
    ...
    <el-button size="mini" type="primary" @click="closeCustomer">停用客户</el-button>
    <el-button type="primary" size="mini" @click="openCustomer" style="margin-top:6px;margin-left:0px">启用客户</el-button>
  </div>
